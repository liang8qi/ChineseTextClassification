...
def feed_data(x_batch, y_batch, keep_prob, in_training_mode):
    ...
    feed_dict = {
        ...
        model.in_training_mode: in_training_mode
    }
    return feed_dict
...
def train(x_train_src, y_train_src, x_valid_src, y_valid_src, model_src):
    ...
    require_improvement = 1000  # 如果超过n iter未提升，提前结束训练
    ...
    for epoch in range(config.num_epochs):
        ...
        for x_batch, y_batch in batch_train:
            ...
            feed_dict = feed_data(x_batch, y_batch, 0.5, True)
