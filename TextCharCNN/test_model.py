...
import numpy as np
from char_cnn_model2 import CharCNNConfig, CharCNN
import os
import time
...
if __name__ == "__main__":
    # 模型路径
    model_save_src = "data/model2"
    num_category = 9
    x_src = "data/vectorized_data/test/x.npy"
    y_src = "data/vectorized_data/test/y.npy"

    result_src = "data/results/test2_pre.npy"
    vocab_src = "data/middle_result/train/vocab.npy"
    data = Data()
